...
You normally don't edit this file. It gives you:
  ...
  * LLM                    — an OpenAI-compatible chat client that reads
...
# Load environment variables from .env in the project root (where this file lives).
...
# LLM: read from environment. No hardcoded defaults so BYOK providers work.
LLM_BASE_URL = os.getenv("LLM_BASE_URL", "")
LLM_API_KEY = os.getenv("LLM_API_KEY")
MODEL = os.getenv("MODEL", "")
# Optional OpenRouter identification headers.
LLM_REFERER = os.getenv("LLM_REFERER", "http://localhost:9002")
LLM_TITLE = os.getenv("LLM_TITLE", "Sitrep Agent")
